...
- En la máquina apodada “pollo asado”, la orientación mostrada en la foto (cabeza en el extremo habitual) se registra con énfasis en cuádriceps. La orientación invertida —cabeza al extremo contrario y puntas de los pies hacia donde normalmente queda la cabeza— se registra como prensa compuesta con énfasis femoral/posterior, según el uso real de Alejandro; no presentarla como curl aislado.
