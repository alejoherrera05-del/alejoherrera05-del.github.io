...
const exerciseNames: Record<Muscle, Array<[string, Equipment, string, string, string?]>> = {
  ...
  Cuádriceps: [
    ...
    ["Prensa “pollo asado” · orientación normal", "Máquina", "4 × 8–12", "Acuéstate como en la foto: cabeza en el extremo habitual del banco y pies hacia la guía. Apoya espalda y pelvis, empuja sin bloquear las rodillas. Esta es la variante que registramos con énfasis en cuádriceps.", "prensa vertical normal|pollo asado normal|pollo asado cuádriceps|prensa de cuádriceps"],
  ],
  Glúteos: [
  ...
  Femorales: [
    ...
    ["Prensa “pollo asado” · orientación invertida", "Máquina", "4 × 8–12", "Gira todo el cuerpo: coloca la cabeza en el extremo contrario del banco y orienta las puntas de los pies hacia donde normalmente queda la cabeza. Mantén la pelvis estable y controla la bajada. La registramos como prensa compuesta con énfasis femoral/posterior, no como curl aislado.", "pollo asado al revés|pollo asado femoral|prensa femoral invertida|prensa posterior|prensa vertical inversa"],
  ],
  Aductores: [
...
const exerciseImageOverride: Record<string, string> = {
  ...
  "Prensa “pollo asado” · orientación normal": "/assets/exercises/quads-vertical-leg-press-v1.png",
  ...
  "Prensa “pollo asado” · orientación invertida": "/assets/exercises/hamstrings-vertical-press-reverse-v2.png",
